			...
			<div class="min-h-full w-10/12 py-14">
				<div class="flex justify-between items-center">
					<div class="flex flex-col">
						...
						<p class="text-sm text-slate-500">Review and manage declined online consultations</p>
					</div>
				</div>
					...
					<div class="flex flex-col gap-2 px-4 py-2 border rounded-md mt-5">
						...
						<table id="request-table" class="bg-white text-sm">
							...
							<tbody>
								...
								<?php
									foreach ($data['declined-requests-data'] as $key => $row):
...
<script>
	<?php
		require APPROOT.'/views/consultation/declined/declined.js';
	?>
</script>
