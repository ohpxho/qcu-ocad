...
<div id="meeting-schedule-panel" class="fixed z-35 top-0 w-1/2 h-full bg-white card-box-shadow -right-full transition-all ease-in-out delay-250 overflow-y-scroll pt-9">
	<div class="flex gap-2">
...
<div id="update-status-panel" class="fixed z-35 top-0 w-1/2 h-full bg-white card-box-shadow -right-full transition-all ease-in-out delay-250 overflow-y-scroll pt-9">
	<div class="flex gap-2">
					...
					<div class="flex flex-col mt-5">
						<div class="flex flex-col gap2 w-full">
							...
							<select name="status" class="border rouded-sm border-slate-300 py-1 px-2 outline-1 outline-blue-500 mt-4 text-neutral-700">
								...
								<option value="unresolve">not resolve</option>
							</select>
						</div>
