...
<div class="flex justify-between items-center">
	...
	<div >
		<a href="<?php echo URLROOT;?>/consultation/add"><li class="flex bg-blue-700 text-white rounded-md px-4 py-1"> New Request </li></a>
	</div>
</div>
			...
			?>
					<tr class="border-b border-slate-200">
						...
						<td class="text-center">
							...
							<a class="text-red-700 drop-btn" href="<?php echo URLROOT.'/consultation/drop/'.$row->id ;?>" >drop</a>
						</td>
