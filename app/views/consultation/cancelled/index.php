			...
			<div class="min-h-full w-10/12 py-14 z-20">
				<div class="flex justify-between items-center">
					<div class="flex flex-col">
						...
						<p class="text-sm text-slate-500">Review and manage cancelled online consultations</p>
					</div>
				</div>
					...
					<div class="flex flex-col gap-2 px-4 py-2 border rounded-md bg-white mt-5">
						...
						<table id="request-table" class="bg-slate-50 text-sm">
							...
							<tbody>
								...
								<?php
									foreach ($data['cancelled-requests-data'] as $key => $row):
										...
										<tr class="border-b border-slate-200">
											...
											<td>
												...
												<?php elseif($row->status == 'unresolved'): ?>
													<span class="bg-red-100 text-red-700 rounded-full px-5 py-1"><?php echo 'cancelled' ?></span>
												<?php elseif($row->status == 'rejected'): ?>
													<span class="bg-red-100 text-red-700 rounded-full px-5 py-1"><?php echo 'declined' ?></span>
												<?php endif; ?>
...
<script>
	<?php
		require APPROOT.'/views/consultation/cancelled/cancelled.js';
	?>
</script>
