		...
		<div class="flex justify-center w-full h-full overflow-y-scroll">
			<div class="h-max w-10/12 py-14 pb-24">
				...
				<div class="w-10/12">
					...
					?>
					<form method="POST" action="<?php echo URLROOT;?>/alumni/add">
						...
						<div class="flex flex-col mt-5 w-full">
							...
							<input name="year-graduated" class="border rounded-sm border-slate-300 py-1 px-2 outline-1 outline-blue-500 mt-2" required/>
						</div>

						<input class=" mt-10 rounded-sm bg-blue-700 text-white border w-max px-5 py-1 rounded-md cursor-pointer" type="submit" value="Add new alumni"/>
...
<script>
	<?php require APPROOT.'/views/alumni/add/add.js'; ?>
</script>
