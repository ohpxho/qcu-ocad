...
<main class="flex w-full h-full justify-center items-center mt-20 pb-20" role="main">
	<div class="w-1/4 max-w-sm flex flex-col justify-center items-center border rounded-md px-4 py-6">
		...
		<form class="flex mt-5 w-full flex-col flex-1" action="<?php echo URLROOT; ?>/alumni/login" method="POST">
			...
			<div class="flex flex-col gap-2 mt-5">
				...
				<span class="text-sm">You don't have an account yet? <a href="<?php echo URLROOT?>/alumni/register" class="text-blue-700">Create an account</a></span>
			</div>
		</form>
	</div>
</main>
