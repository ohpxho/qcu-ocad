<li class="flex flex-col py-1 rounded-sm">
	<a id="document-request-dropdown-btn" class=" flex items-center gap-2 justify-between hover:bg-slate-700 py-1 px-2">
	...
	<ul id="document-request-menu" class="h-max overflow-hidden pl-1">
		<a href="<?php echo URLROOT; ?>/good_moral/pending" >
			<li class="flex py-1 px-4 justify-between items-center hover:bg-slate-700 rounded-sm <?php echo $data['document-pending-nav-active'] ?>">
				<p>Pending</p>
		...
		<a href="<?php echo URLROOT; ?>/good_moral/accepted" >
			<li class="flex py-1 px-4 justify-between items-center hover:bg-slate-700 rounded-sm <?php echo $data['document-accepted-nav-active'] ?>">
				<p>Accepted</p>
		...
		<a href="<?php echo URLROOT; ?>/good_moral/inprocess" >
			<li class="flex py-1 px-4 justify-between items-center hover:bg-slate-700 rounded-sm <?php echo $data['document-inprocess-nav-active'] ?>">
				<p>In Process</p>
		...
		<a href="<?php echo URLROOT; ?>/good_moral/forclaiming" >
			<li class="flex py-1 px-4 justify-between items-center hover:bg-slate-700 rounded-sm <?php echo $data['document-forclaiming-nav-active'] ?>">
				<p>For Claiming</p>
		...
		<a href="<?php echo URLROOT; ?>/good_moral/records" >
			<li class="flex py-1 px-4 justify-between items-center hover:bg-slate-700 rounded-sm <?php echo $data['document-records-nav-active'] ?>">
				<p>Request Records</p>
				<div id="forclaiming-count" class="flex items-center text-white justify-center rounded-full bg-red-500 h-4 w-4 hidden">
					<span class="text-center text-[10px]"></span>
				</div>
...
<li class="flex flex-col py-1 rounded-sm">
	<a id="consultation-dropdown-btn" class=" flex items-center gap-2 justify-between hover:bg-slate-700 py-1 px-2">
		<p>Consultation</p>
	...
	<ul id="consultation-menu" class="h-max overflow-hidden pl-1">
		<a href="<?php echo URLROOT; ?>/consultation/request">
			<li class="flex py-1 px-4 justify-between items-center hover:bg-slate-700 rounded-sm <?php echo $data['consultation-request-nav-active'] ?>">
		...
		<a href="<?php echo URLROOT; ?>/consultation/active">
			<li class="flex py-1 px-4 justify-between items-center hover:bg-slate-700 rounded-sm <?php echo $data['consultation-active-nav-active'] ?>">
		...
		<a href="<?php echo URLROOT; ?>/consultation/records">
			<li class="flex py-1 px-4 hover:bg-slate-700 rounded-sm <?php echo $data['consultation-records-nav-active'] ?>">
