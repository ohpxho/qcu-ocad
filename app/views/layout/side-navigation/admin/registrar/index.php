<li class="flex flex-col py-1 text-slate-700 rounded-sm">
	...
	<ul id="document-request-menu" class="h-max overflow-hidden pl-1">
		<a href="<?php echo URLROOT; ?>/academic_document/pending" >
			<li class="flex items-center justify-between py-1 px-4 hover:bg-slate-200 text-slate-700 rounded-sm <?php echo $data['document-pending-nav-active'] ?>">
		...
		<a href="<?php echo URLROOT; ?>/academic_document/accepted" >
			<li class="flex items-center justify-between py-1 px-4 hover:bg-slate-200 text-slate-700 rounded-sm <?php echo $data['document-accepted-nav-active'] ?>">
		...
		<a href="<?php echo URLROOT; ?>/academic_document/inprocess" >
			<li class="flex items-center justify-between py-1 px-4 hover:bg-slate-200 text-slate-700 rounded-sm <?php echo $data['document-inprocess-nav-active'] ?>">
		...
		<a href="<?php echo URLROOT; ?>/academic_document/forclaiming" >
			<li class="flex items-center justify-between py-1 px-4 hover:bg-slate-200 text-slate-700 rounded-sm <?php echo $data['document-forclaiming-nav-active'] ?>">
