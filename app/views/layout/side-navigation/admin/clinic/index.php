<a href="<?php echo URLROOT; ?>/consultation/request">
	<li class="flex py-1 px-2 justify-between items-center hover:bg-slate-200 text-slate-700 rounded-sm <?php echo $data['consultation-request-nav-active'] ?>">
...
<a href="<?php echo URLROOT; ?>/consultation/active">
	<li class="flex py-1 px-2 justify-between items-center hover:bg-slate-200 text-slate-700 rounded-sm <?php echo $data['consultation-active-nav-active'] ?>">
...
<script>
	<?php
		require APPROOT.'/views/layout/side-navigation/admin/clinic/clinic.js';
	?>
</script>