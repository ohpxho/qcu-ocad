<li class="flex flex-col py-1 rounded-sm">
	...
	<ul id="document-request-menu" class="h-max overflow-hidden pl-1">
		<a href="<?php echo URLROOT; ?>/academic_document/records">
			<li class="flex py-1 px-4 hover:bg-slate-700 rounded-sm <?php echo $data['document-nav-active'] ?>">
				<p>Academic Document</p>
			</li>
		</a>

		<a href="<?php echo URLROOT; ?>/good_moral/records">
			<li class="flex py-1 px-4 hover:bg-slate-700 rounded-sm <?php echo $data['moral-nav-active'] ?>">
				<p>Good Moral</p>
			</li>
		</a>

		<a href="<?php echo URLROOT; ?>/soa_and_order_of_payment/records">
			<li class="flex py-1 px-4 hover:bg-slate-700 rounded-sm <?php echo $data['soa-nav-active'] ?>">
...
<li class="flex flex-col py-1 rounded-sm">
	...
	<ul id="document-request-menu" class="h-max overflow-hidden pl-1">
		<a href="<?php echo URLROOT; ?>/user/student">
			<li class="flex py-1 px-4 hover:bg-slate-700 rounded-sm <?php echo $data['student-nav-active'] ?>">
				<p>Student</p>
			</li>
		</a>

		<a href="<?php echo URLROOT; ?>/user/alumni">
			<li class="flex py-1 px-4 hover:bg-slate-700 rounded-sm <?php echo $data['alumni-nav-active'] ?>">
				<p>Alumni</p>
			</li>
		</a>

		<a href="<?php echo URLROOT; ?>/user/admin">
			<li class="flex py-1 px-4 hover:bg-slate-700 rounded-sm <?php echo $data['admin-nav-active'] ?>">
				<p>Admin</p>
			</li>
		</a>

		<a href="<?php echo URLROOT; ?>/user/professor">
			<li class="flex py-1 px-4 hover:bg-slate-700 rounded-sm <?php echo $data['professor-nav-active'] ?>">
				<p>Professor</p>
			</li>
		</a>
	</ul>
...
<a href="<?php echo URLROOT; ?>/setting" >
	<li class="flex py-1 px-2 hover:bg-slate-700 rounded-sm <?php echo $data['setting-nav-active'] ?>">
		<p>Settings</p>
	</li>
</a>
