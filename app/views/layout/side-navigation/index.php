<div class="sm:hidden md:flex flex-col w-60 h-full grow-0 shrink-0 bg-white text-sm nav-box-shadow text-white" style="background-color:rgba(0,0,0,0.8)">
	<div class="flex flex-col h-full">
		...
		<ul class="flex flex-col px-2 border-b pb-4">
			...
			<a href="#" ><li class="flex gap-2 py-1 px-2 items-center hover:bg-blue-200 text-white rounded-sm">
