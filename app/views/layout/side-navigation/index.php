<div class="flex flex-col w-60 h-full grow-0 shrink-0 bg-white text-sm nav-box-shadow text-white" style="background-color:rgba(0,0,0,0.8)">
	<div class="flex flex-col h-full">
		
		<!------------------------------------------ profile --------------------------------------------------------->
		
		<div class="flex flex-col gap-1 py-5 pb-6 px-4 text-white ">
		...
		<ul class="flex flex-col px-2 border-b pb-4">
			...
			<a href="#" ><li class="flex gap-2 py-1 px-2 items-center hover:bg-slate-200 text-white rounded-sm">
			...
			<a href="#"><li class="flex gap-2 py-1 px-2 items-center hover:bg-white text-white rounded-sm">
		...
		<ul class="flex flex-col mt-5 px-2">
			...
			<a href="<?php echo URLROOT; ?>/home/index"><li class="flex py-1 px-2 hover:bg-slate-900 text-white rounded-sm <?php echo $data['dashboard-nav-active'] ?>" style="background-color: rgba(0,0,0,0.00); ">
				<p>Dashboard</p>
			</li></a>
	...
	<div class="flex items-center px-2 py-4 border-t w-full h-max text-xs text-white">
