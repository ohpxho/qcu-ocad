<div class="flex flex-col w-60 h-full grow-0 shrink-0 bg-slate-800 text-slate-300 text-sm nav-box-shadow">
	<div class="flex flex-col h-full">
		...
		<ul class="flex flex-col px-2 border-b pb-4">
			...
			<a href="<?php echo URLROOT ?>/user/profile" ><li class="flex gap-2 py-1 px-2 items-center hover:bg-slate-700 rounded-sm <?php echo $data['profile-nav-active'] ?>">
			...
			<a href="#"><li class="flex gap-2 py-1 px-2 items-center hover:bg-slate-700 rounded-sm <?php echo $data['notification-nav-active'] ?>">
		...
		<ul class="flex flex-col mt-5 px-2">
			...
			<a href="<?php echo URLROOT; ?>/user/dashboard"><li class="flex py-1 px-2 hover:bg-slate-700 rounded-sm <?php echo $data['dashboard-nav-active'] ?>">
				<p>Dashboard</p>
			</li></a>
