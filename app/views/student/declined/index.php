...
<main class="flex items-center justify-center w-full h-full min-h-full py-4" role="main">
	<div class="w-1/4 bg-slate-50 h-3/4 flex flex-col shadow-sm pt-5">
		...
		<div id="registration-form" class="w-full h-full shadow-md mb-2 px-10 pb-20 overflow-hidden hover:overflow-y-scroll">
			<?php
			...
			<form id="reg-form" class="flex w-full flex-col flex-1 mt-7" action="<?php echo URLROOT.'/student/declined/'.$data['details']->id; ?>" enctype="multipart/form-data" method="POST">
				...
				<!------------------------------------------------ personal details -------------------------------------------------------->
					...
					<div class="flex flex-col mt-5 w-full">
						...
						<p class="text-orange-500" id="remarks">...</p>
					</div>
