			...
			<div class="min-h-full w-10/12 py-14">
				...
				<div class="flex justify-between items-center">
					<div class="flex flex-col">
						<p class="text-2xl font-bold">Professor Management</p>
						<p class="text-sm text-slate-500">Review and manage professor accounts</p>
					</div>
				</div>
				...
				<div class="flex flex-col mt-5 gap-2 pb-24">
					...
					<div class="flex flex-col gap-2 px-4 py-2 border rounded-md mt-5">
						<div class="flex items-center justify-between py-2">
							<p class="p-2 text-lg font-semibold">Professor Summary</p>
							<div class="flex gap-2 items">
								...
								<a href="<?php echo URLROOT;?>/professor/add">
									<li class="flex gap-1 items-center bg-blue-700 text-white rounded-md px-4 py-1"> 
										...
										<span>New Professor Account</span> 
									</li>
								</a>
								...
								<form action="<?php echo URLROOT;?>/user/multiple_delete/professor" method="POST" id="multiple-drop-form" class="hidden">
						...
						<table id="request-table" class="bg-white text-sm">
							<thead class="bg-slate-100 text-slate-900 font-medium">
								<tr>
									<th class="flex gap-2 items-center"><input id="select-all-row-checkbox" type="checkbox">Professor ID</th>
									<th>Email</th>
									<th>Lastname</th>
									<th>Firstname</th>
									<th>Department</th>
							...
							<tbody>
								...
								<?php
									foreach ($data['professors'] as $key => $row):
								?>
...
<script>
	<?php
		require APPROOT.'/views/user/professor/professor.js';
	?>
</script>