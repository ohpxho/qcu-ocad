		...
		<div class="flex justify-center w-full h-full overflow-y-scroll">
			<div class="h-max w-10/12 py-14 pb-24">
				<div class="flex flex-col">
					<p class="text-3xl font-bold">Add new Teacher</p>
					<p class="text-sm text-slate-500">Creat new Teacher account </p>
				</div>
				...
				<form method="POST" action="<?php echo URLROOT;?>/consultation/add" enctype="multipart/form-data">
						...
						<div class="flex flex-col w-full mt-5 gap-2">
							<div class="flex w-full gap-1">
								...
								<select name="email" class="border rouded-sm border-slate-300 py-1 px-2 outline-1 outline-blue-500 mt-2 text-neutral-700" required>
						...
						<div class="flex flex-col w-full mt-5 gap-2">
							<div class="flex w-full gap-1">
								...
								<div class="flex flex-col w-full">
									...
									<input lname="pword" class="border rouded-sm border-slate-300 py-1 px-2 outline-1 outline-blue-500 mt-2 text-neutral-700" type="password" required>
								</div>
							</div>
						</div>
...
<script>
	<?php require APPROOT.'/views/user/professor/add/add.js'; ?>
</script>
