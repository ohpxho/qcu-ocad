	...
	<?php if($_SESSION['type'] != 'sysadmin'): ?>
				...
				<div class="flex gap-1 w-1/2">
					<div class="flex flex-col mt-3">
						...
						<div class="flex flex-col mt-3 gap-1">
							...
							<input type="email" name="email" value="" class="focus:bg-white cursor-not-allowed border rouded-md bg-slate-100 border-slate-300 px-2 py-0.5 outline-1 outline-blue-500 text-neutral-700" readonly>
		...
		<form method="POST" action="<?php echo URLROOT; ?>/user/profile/update/personal_details" >
			...
			<div class="w-7/12 mt-5">
				<p class="text-lg font-medium">Admin Details</p>
				...
				<div class="flex gap-1 items-center mt-3">
					...
					<div class="w-1/2 flex flex-col gap-1">
						...
						<input type="text" name="fname" class="focus:bg-white border cursor-not-allowed rouded-md bg-slate-100 border-slate-300 py-0.5 px-2 outline-1 outline-blue-500 text-neutral-700" readonly>
					</div>
				</div>
		...
		<div class="flex gap-1">
			...
			<form method="POST" action="<?php echo URLROOT; ?>/user/profile/update/personal_details" >
				...
				<div class="w-7/12 mt-5">
					...
					<div class="flex flex-col gap-1 mt-3 hidden">
						<input type="email" name="email" class="focus:bg-white border rouded-md bg-slate-100 border-slate-300 py-0.5 px-2 outline-1 outline-blue-500 text-neutral-700" readonly> 
					</div>
...
<script>
	<?php
		require APPROOT.'/views/user/profile/admin/admin.js';
	?>
</script>
