							...
							<div class="flex flex-col shadow-sm gap-2 w-2/6 bg-white p-4 border rounded-md">
								...
								<table class="w-full table-fixed mt-3">
									<?php
										...
										$soa = isset($freq->SOA)? $freq->SOA : '0';
										$oop = isset($freq->ORDER_OF_PAYMENT)? $freq->ORDER_OF_PAYMENT : '0';
									?>
									<tr>
									...
									<tr>
										...
										<td width="20" class="py-2 text-center border bg-slate-50"><span id="gradeslip-count"><?php echo $soa ?></span></td>
									</tr>

									<tr>
										<td width="80" class="py-2 pl-2 border border text-sm">Order of Payment</td>
										<td width="20" class="py-2 text-center border bg-slate-50"><span id="ctc-count"><?php echo $oop ?></span></td>
									</tr>
								</table>
							</div>	
