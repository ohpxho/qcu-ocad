			...
			<div class="min-h-full w-10/12 py-14 z-20">
				...
				<div class="flex justify-between items-center">
					<div class="flex flex-col">
						...
						<p class="text-sm text-slate-500">Review and manage completed request</p>
					</div>
				</div>
				...
				<div class="flex flex-col mt-5 gap-2 pb-24">
					...
					<div class="flex flex-col gap-2 bg-white px-4 py-2 border rounded-md mt-5">
...
<script>
	<?php
		require APPROOT.'/views/soa-and-order-of-payment/completed/completed.js';
	?>
</script>
