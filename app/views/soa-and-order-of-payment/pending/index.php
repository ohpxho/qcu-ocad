...
<main class="flex flex-con h-full w-full overflow-hidden">
				...
				<div id="update-panel" class="fixed z-35 top-0 w-1/2 h-full bg-white card-box-shadow -right-full transition-all ease-in-out delay-250 overflow-y-scroll pt-16">
					...
					<div class="flex justify-center w-full h-max">
						<div class="flex flex-col w-10/12 pt-10 pb-20">
							...
							<div class="w-full">
								<form id="update-form" action="<?php echo URLROOT; ?>/student_account/pending/single" method="POST" class="w-full">
				...
				<div id="multiple-update-panel" class="fixed z-35 top-0 w-1/2 h-full bg-white card-box-shadow -right-full transition-all ease-in-out delay-250 overflow-y-scroll pt-16">
					...
					<div class="flex justify-center w-full h-max">
						<div class="flex flex-col w-10/12 pt-10 pb-20">
							...
							<div class="w-full">
								<form id="multiple-update-form" action="<?php echo URLROOT; ?>/student_account/pending/multiple" method="POST" class="w-full">
	...
	<div id="changes-notice-modal" class="fixed bottom-10 right-10 h-max flex flex-col p-4 rounded-md gap-2 border bg-orange-200 text-orange-500 z-50 hidden">
		...
		<a class="underline" href="<?php echo URLROOT?>/student_account/pending">show</a>
	</div>
</main>
...
<script>
	<?php
		require APPROOT.'/views/soa-and-order-of-payment/pending/pending.js';
	?>
</script>
