											...
											<tr class="border-b border-slate-200">
												...
												<td class="text-center">
													<div class="flex gap-1 items-center justify-center">
														...
														<?php if($_SESSION['type'] != 'sysadmin'): ?><a class="hover:text-blue-700 update-btn" class="text-blue-700" href="#">update</a><?php endif; ?>
					...
					<div id="crystal-report-modal" class="flex flex-col gap-2 justify-center items-center h-max w-full top-0 left-0 z-20 hidden">
						...
						<div id="crystal-report" class="w-10/12 p-6 h-max bg-white border rounded-md">	
							...
							<div class="w-full mt-5">
								<div id="grouped-bar-chart flex gap-2 flex-col items-center justify-center w-full">
				...
				<div id="update-panel" class="fixed z-35 top-0 w-1/2 h-full bg-white card-box-shadow -right-full transition-all ease-in-out delay-250 overflow-y-scroll pt-16">
					...
					<div class="flex justify-center w-full h-max">
						<div class="flex flex-col w-10/12 pt-10 pb-20">
							...
							<div class="w-full">
								<form id="update-form" action="<?php echo URLROOT; ?>/student_account/records" method="POST" class="w-full">
