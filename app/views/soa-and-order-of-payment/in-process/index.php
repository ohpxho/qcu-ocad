...
<main class="flex flex-con h-full w-full overflow-hidden">
			...
			<div class="min-h-full w-10/12 py-14 z-20">
				...
				<div class="flex justify-between items-center">
					<div class="flex flex-col">
						...
						<p class="text-sm text-slate-500">Review and manage for process requests</p>
					</div>
				</div>
					...
					<div class="flex justify-center w-full h-max">
						<div class="flex flex-col w-10/12 pt-10 pb-20">
							<div class="flex flex-col gap2 w-full">
								...
								<p class="text-sm text-slate-500">Update student's student account documents request</p>
							</div>

							<div class="w-full">
								<form id="update-form" action="<?php echo URLROOT; ?>/student_account/forprocess/single" method="POST" class="w-full">
				...
				<div id="multiple-update-panel" class="fixed z-35 top-0 w-1/2 h-full bg-white card-box-shadow -right-full transition-all ease-in-out delay-250 overflow-y-scroll pt-16">
					...
					<div class="flex justify-center w-full h-max">
						<div class="flex flex-col w-10/12 pt-10 pb-20">
							...
							<div class="w-full">
								<form id="multiple-update-form" action="<?php echo URLROOT; ?>/student_account/forprocess/multiple" method="POST" class="w-full">
	...
	<div id="changes-notice-modal" class="fixed bottom-10 right-10 h-max flex flex-col p-4 rounded-md gap-2 border bg-orange-200 text-orange-500 z-50 hidden">
		...
		<a class="underline" href="<?php echo URLROOT?>/student_account/forprocess">show</a>
	</div>
</main>
...
<script>
	<?php
		require APPROOT.'/views/soa-and-order-of-payment/in-process/in-process.js';
	?>
</script>
