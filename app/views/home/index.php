...
<main class="flex w-full h-full justify-center items-center mt-20 pb-20" role="main">
	<div style="background: url('<?php echo URLROOT;?>/public/assets/img/qcu.jpg'); background-size: cover;x background-position: center;
  background-repeat: no-repeat; opacity:.7" class="absolute h-full w-full top-0 left-0" >
</div>
	<div class="sm:w-full md:w-1/4 w-10/12 max-w-sm h-1/2 flex flex-col justify-center items-center">
