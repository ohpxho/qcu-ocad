					...
					<div class="grid w-full justify-items-end mt-5">
						<div class="flex w-full gap-2 border p-4 bg-white rounded-md items-end">
							<div class="flex flex-col gap-1 w-1/2">
								...
								<input id="search" class="border rounded-sm border-slate-300 bg-slate-50 py-1 px-2 outline-1 outline-blue-500 caret-blue-500" type="text" />
							</div>

							<div class="flex flex-col gap-1 w-1/4">
								<p class="font-semibold">Type</p>
								<select id="type-filter" class="border rouded-sm border-slate-300 bg-slate-50 py-1 px-2 outline-1 outline-blue-500 text-neutral-700">
							...
							<div class="flex flex-col gap-1 w-1/4">
								...
								<select id="purpose-filter" class="border rouded-sm border-slate-300 bg-slate-50 py-1 px-2 outline-1 outline-blue-500 text-neutral-700">
									<option value="">All</option>
...
<script>
	<?php
		require APPROOT.'/views/good-moral/declined/declined.js';
	?>
</script>
