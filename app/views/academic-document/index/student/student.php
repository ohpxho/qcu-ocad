			...
			<div class="flex flex-col shadow-sm gap-2 w-2/6 p-4 border rounded-md">
				...
				<table class="w-full table-fixed mt-3">
					<?php
						...
						$gradeslip = isset($freq->GRADESLIP)? $freq->GRADESLIP : '0';
						$ctc = isset($freq->CTC)? $freq->CTC : '0';
						$others = isset($freq->OTHERS)? $freq->OTHERS : '0';
					?>
					<tr>
					...
					<tr>
						...
						<td width="20" class="py-2 text-center border bg-slate-50"><span id="gradeslip-count"><?php echo $gradeslip ?></span></td>
					</tr>

					<tr>
						<td width="80" class="py-2 pl-2 border border text-sm">Certified True Copy</td>
						<td width="20" class="py-2 text-center border bg-slate-50"><span id="ctc-count"><?php echo $ctc ?></span></td>
					</tr>

					<tr>
						<td width="80" class="py-2 pl-2 border border text-sm">Others</td>
						<td width="20" class="py-2 text-center border bg-slate-50"><span id="others-count"><?php echo $others ?></span></td>
					</tr>
				</table>
			</div>	
...
<script>
	<?php
		require APPROOT.'/views/academic-document/index/student/student.js';
	?>
</script>
