...
<div class="flex flex-col mt-1 sm:mt-5 gap-2 pb-24">
	...
	<div class="flex flex-col gap-2 px-4 py-2 border rounded-md mt-5 bg-white shadow-md">
		...
		<div class="overflow-x-scroll pb-4">
			<table id="ongoing-table" class="bg-slate-50 text-sm min-w-max mb-3">
	...
	<div class="grid w-full md:justify-items-end mt-5 shadow-md">
	...
	<div class="flex flex-col gap-2 px-4 py-2 border rounded-md mt-5 bg-white shadow-md">
		...
		<div class="overflow-x-scroll pb-4">
			<table id="history-table" class="bg-slate-50 text-sm min-w-max mb-3">
				<thead class="bg-slate-100 text-slate-900 font-medium">
					<tr>
						<th class="hidden">Request ID</th>
						<th>Date Requested</th>
...
<div id="changes-notice-modal"  class="fixed h-full w-full top-0 left-0 z-50 hidden">
	<div class="fixed bottom-10 right-10 h-max flex flex-col p-4 rounded-md gap-2 border bg-orange-200 text-orange-500 z-50">
		...
		<a class="underline" href="<?php echo URLROOT?>/academic_document">show</a>
	</div>
</div>
