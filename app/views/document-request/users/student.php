			...
			?>
					<tr class="border-b border-slate-200">
						...
						<?php if($row->status == 'pending'): ?>
							<td>
								<span class="bg-yellow-100 text-yellow-700 rounded-full px-5 text-sm py-1">pending</span>
							</td>
						<?php endif; ?>

						<?php if($row->status == 'accepted'): ?>
							<td>
								<span class="bg-cyan-100 text-cyan-700 rounded-full px-5 text-sm py-1">accepted</span>
							</td>
						<?php endif; ?>

						<?php if($row->status == 'rejected'): ?>
							<td>
								<span class="bg-red-100 text-red-700 rounded-full px-5 text-sm py-1">rejected</span>
							</td>
						<?php endif; ?>
						...
						<td class="text-center">
							...
							<?php if($row->status == 'pending'): ?>
								<a class="text-green-700" href="<?php echo URLROOT.'/academic_document/edit/'.$row->id ;?>">edit</a>
