		...
		<div class="flex justify-center w-full h-full overflow-y-scroll">
			<div class="h-max w-10/12 py-14 pb-24">
				...
				<div class="flex flex-col mt-5">
					<p class="text-2xl font-bold">Update Admin</p>
					<p class="text-sm text-slate-500">Update account of admin</p>
				</div>
				...
				<div class="w-10/12">
					...
					?>
					<form method="POST" action="<?php echo URLROOT;?>/admin/update/<?php echo $data['records']->id ?>">
...
<script>
	<?php require APPROOT.'/views/admin/edit/edit.js'; ?>
</script>
